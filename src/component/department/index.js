...
import dep_img from './department.jpg'
...
const Greet = () => {
    return (
        ...
        //         <div className="col-lg-6 col-12"><img src= {dep_img} alt="department_pic" class={style.image}/></div>
        //         <div className="col-lg-6 col-12"><p className={style.dept_1}>{para1}<br/><br/>{para1_1}</p></div>
        //      </div>
